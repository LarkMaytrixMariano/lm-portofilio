...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Lark Mariano
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description"> I'm a creative Developer based in Philippines,
        and I'm very passionate and dedicated to my work or project.</p>
