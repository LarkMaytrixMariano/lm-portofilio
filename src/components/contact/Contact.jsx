  ...
  return (
    ...
    <span className="section__subtitle">Contact Me
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <a href="mailto:exampleemail@gmail.com.com" className="contact__button">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">999-798-6507</span>
            ...
            <div className="contact__content">
                <h3 className="contact__title">Write me your project
                </h3>
